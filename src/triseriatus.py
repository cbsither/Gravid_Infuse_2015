...
plt.hist(triseriatus.oak_by_date, bins=bins, color='blue', alpha=0.3, label=f'Oak Data', density=True)
...
plt.ylabel('Density')
plt.legend()
plt.savefig(f"../figs/triseriatus/triseriatus_poisson_histogram_emp_data_oak.png")
plt.clf()

plt.hist(triseriatus.grass_by_date, bins=bins, color='blue', alpha=0.3, label=f'Grass Data', density=True)
...
plt.ylabel('Density')
plt.legend()
plt.savefig(f"../figs/triseriatus/triseriatus_poisson_histogram_emp_data_grass.png")
plt.clf()
...
plt.ylabel('Density')
plt.legend()
plt.savefig(f"../figs/triseriatus/triseriatus_poisson_histogram.png")
